...
void select_file(GtkWidget *widget,gpointer data)//点击主界面的按钮后，执行。
{
    ...
    file=file=gtk_file_chooser_dialog_new("SelectFile",NULL,GTK_FILE_CHOOSER_ACTION_OPEN,GTK_STOCK_CANCEL,GTK_RESPONSE_CANCEL,GTK_STOCK_OK,GTK_RESPONSE_ACCEPT,NULL);    //若（点击确认按钮）？？
